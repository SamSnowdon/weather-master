...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    @Override
    public Map<Integer, Map[]> fetchAllEmployeesByAges(List<Integer> ages) throws NotFoundException {
        ...
        Map<Integer, Map[]> empMap = CompletableFuture.allOf(completableFutureList.toArray(new CompletableFuture[0]))
                    .thenApply(VOID -> {
